...
public class Camera2BasicFragment extends Fragment
    ...
    private void createCameraPreviewSession() {
        try {
            ...
            Log.d(TAG, "create session, image size " +
                    mYUVImageReader.getWidth() + "x" + mYUVImageReader.getHeight() +
                    ", preview size " + mPreviewSize.getWidth() +"x"+ mPreviewSize.getHeight());
            InputConfiguration inputConfiguration =
                    new InputConfiguration(mYUVImageReader.getWidth(), mYUVImageReader.getHeight(),
                            ImageFormat.YUV_420_888);
            mCameraDevice.createReprocessableCaptureSession(inputConfiguration,
                    Arrays.asList(surface, mYUVImageReader.getSurface(), mImageReader.getSurface()),
                        ...
                        public void onConfigured(@NonNull CameraCaptureSession cameraCaptureSession) {
                            ...
                            try {
                                ...
                                mImageWriter = ImageWriter.newInstance(
                                        mCaptureSession.getInputSurface(), MAX_IMAGE_CNT);
                            } catch (CameraAccessException e) {
                                e.printStackTrace();
                            }
                        }
    ...
    private void captureStillPicture() {
        try {
            ...
            captureBuilder.removeTarget(mImageReader.getSurface());
